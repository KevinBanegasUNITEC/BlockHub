...
/**
 * @title Repository
 * @dev Contrato que representa un repositorio descentralizado con sistema de commits y recompensas
 */
contract Repository is ERC721{
    ...
    string repoName;
    string repoFolderCID; // IPFS CID del estado actual del repositorio
